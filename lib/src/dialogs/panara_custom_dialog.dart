    ...
    bool isInfo = false,
      ...
      showDialog<T>(
        ...
        builder: (context) => PanaraCustomDialogWidget(
          ...
          panaraDialogType: panaraDialogType,
          buttonColorYes: buttonColorYes,
          buttonTextColorYes: buttonTextColorYes,
          buttonColorNo: buttonColorNo,
          buttonTextColorNo: buttonTextColorNo,
          color: color,
          imagePath: imagePath,
          noImage: noImage,
          isInfo: isInfo,
  ...
  static Future<T?> showAnimatedFromLeft<T extends Object?>(
    ...
    bool isInfo = false,
      ...
      showGeneralDialog<T>(
        ...
        pageBuilder: (animation, secondaryAnimation, child) => PanaraCustomDialogWidget(
          margin: margin,
          padding: padding,
          backgroundColor: backgroundColor,
          mainAxisAlignment: mainAxisAlignment,
